def normalize_data(n_cases, n_people, scale):
    ...
    for idx, n in enumerate(n_cases):
        new_cases_per_million = n / n_people[idx] * scale
        norm_cases.append(new_cases_per_million)
    return norm_cases
...
for idx, pop in enumerate(n_covid):
    ratio = pop / sum_covid * 100 # TODO) Calculate the ratio of new cases to each region’s COVID-19
